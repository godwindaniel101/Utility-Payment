<template>
  ...
  >
    <header class="flex items-center justify-between">
      <h2 class="text-lg leading-6 font-medium text-black">Bill Records</h2>
    </header>
    <table class="shadow-md rounded w-full">
      <thead class="sticky block top-0" scope="col">
        <tr class="flex text-left">
          <th
            scope="col"
            class="w-3/12 sm:w-1/4 p-2 border bg-white border-r-0 border-gray-300 font-normal"
          >
          ...
          <th
            scope="col"
            class="w-3/12 sm:w-1/4 p-2 border bg-white rounded-tr border-gray-300 font-normal"
          >
